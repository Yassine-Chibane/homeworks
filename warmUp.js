...
/*Let's practice the following array methods. Don't forget to console.log your results */
...
var shoppingList = [
 ...
 console.log('The updated shopping list :', shoppingList)
...
const yodaReversed = yoda.reverse();
console.log('The reversed array is : ', yodaReversed)
...
const nowServing = waitList.shift()
console.log('Now serving: ', nowServing)
console.log('The waiting list is: ', waitList)
...
console.log('The updated waiting list is: ', waitList)
...
testMenu.splice(2,2)
console.log('test menu: ', testMenu)
...
console.log('The ungrateful people list is :', unFriend)